...
async function loadOverview() {
  ...
  try {
    const [openQuotes, acceptedQuotes, totalQuotes, unpaid, recent] = await Promise.all([
    ...
    return { pipeline, winRate, ar, recent: recent.data ?? [], ready: true };
  } catch {
    return { pipeline: 0, winRate: null as number | null, ar: 0, recent: [] as never[], ready: false };
  }
}
